...
describe("TicketsPage", () => {
  ...
  it("should open the create ticket dialog when clicking New Ticket", async () => {
    mockedAxios.get.mockResolvedValue(mockResponse());
    const user = userEvent.setup();
    renderWithQuery(<TicketsPage />);
    ...
    expect(screen.getByRole("heading", { name: "New Agent Ticket" })).toBeInTheDocument();
  });

  it("should create a ticket from the dialog", async () => {
    mockedAxios.get.mockResolvedValue(mockResponse());
    ...
    await user.type(screen.getByLabelText("Subject"), "Printer issue");
    await user.type(screen.getByLabelText("Issue Details"), "The printer is jammed.");

    await user.click(screen.getByRole("button", { name: "Create Ticket" }));

    await waitFor(() => {
      expect(mockedAxios.post).toHaveBeenCalledWith("/api/tickets", {
        senderName: "Jane Doe",
        senderEmail: "jane@example.com",
        subject: "Printer issue",
        body: "The printer is jammed.",
